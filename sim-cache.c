...
/* level 3 instruction cache (ADDED) */ 
...
#define MAX_PCSTAT_VARS 10 // MODIFICATION: increased from 8 to 10 
...
dl2_access_fn(enum mem_cmd cmd,		/* access cmd, Read or Write */
	      ...
	      tick_t now)		/* time of access */
{
  // ADDING LVL 3: Redirect to level 3 cache if it is specified
  if (cache_dl3)
    {
      /* access next level of data cache hierarchy */
...
// ADDING LVL 3: Level 3 data-cache handler function
...
il2_access_fn(enum mem_cmd cmd,		/* access cmd, Read or Write */
	      ...
	      tick_t now)		/* time of access */
{
  // ADDING LVL 3: Redirect to level 3 cache
  if (cache_il3)
    {
      /* access next level of inst cache hierarchy */
...
// ADDING LVL 3: Level 3 instruction-cache handler function.
...
static char *cache_dl3_opt /* = "none" */; // ADD LVL 3
static char *cache_il1_opt /* = "none" */;
static char *cache_il2_opt /* = "none" */;
static char *cache_il3_opt /* = "none" */; // ADD LVL 3
...
"                -dtlb dtlb:128:4096:32:r\n"
  ...
  opt_reg_string(odb, "-cache:dl3",
                 ...
                 &cache_dl3_opt, "ul3:1024:64:4:l", /* print */TRUE, NULL); // ADD LVL 3
...
"      -cache:dl1 ul1:256:32:1:l -cache:dl2 ul2:1024:64:2:l\n"
  ...
  opt_reg_string(odb, "-cache:il3",
                 ...
                 &cache_il3_opt, "dl3", /* print */TRUE, NULL); // ADD LVL 3
		  ...
		  int argc, char **argv)	/* command line arguments */
{
  ...
  if (!mystricmp(cache_dl1_opt, "none"))
      ...
      else
	{
	  ...
	  cache_dl2 = cache_create(name, nsets, bsize, /* balloc */FALSE,
        ...
        // ADD LVL 3: Level 3 data cache creation.
  ...
  // ADD LVL 3: Link il1 with dl3 cache.
  ...
  // END MODIFICATION
      ...
      else if (!mystricmp(cache_il2_opt, "dl2"))
	{
      ...
      // ADD LVL 3: Link il2 with dl3 cache.
      ...
      else
	{
	  ...
	  cache_il2 = cache_create(name, nsets, bsize, /* balloc */FALSE,
          ...
          // ADD LVL 3: Level 3 instruction cache creation.
...
sim_reg_stats(struct stat_sdb_t *sdb)	/* stats database */
{
  ...
  // ADD LVL 3: register il3 and dl3
  if (cache_il1
